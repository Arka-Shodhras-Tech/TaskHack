...
import { Stack, Card, CardHeader, CardBody, Heading, Text, Box, Center } from "@chakra-ui/react";
    ...
    <Stack spacing={8} maxW="3xl" w="full">
        ...
        <Card key={index} className="task-card">
            ...
            <Box textAlign="center">
                <Text className="task-time">Start Time: {task.startTime}</Text>
                <Text className="task-time">End Time: {task.endTime}</Text>
            </Box>
            </CardBody>
        </Card>
        ))}
